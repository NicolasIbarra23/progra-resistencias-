...
public class Resistencia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        p2.add(Calcular);
        Calcular.setBounds(500, 20, 73, 23);
        ...
        color2.setBounds(90, 230, 40, 130);
        ...
        toleranciab.setBounds(330, 230, 40, 130);
        getContentPane().add(multiplicadorb);
        multiplicadorb.setBounds(250, 230, 40, 130);
        getContentPane().add(color3);
        color3.setBounds(150, 230, 40, 130);
        getContentPane().add(color1);
        color1.setBounds(30, 230, 40, 130);
